...
export default function EmbedView({ embedded = false }: EmbedViewProps) {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      setWidgetUrl(`${window.location.origin}/widget/widget.js`);
    }
    api.me()
  ...
  if (!botId) {
    return (
      <div className={`${embedded ? "p-10" : "p-10 min-h-screen"} flex items-center justify-center`}>
  ...
  return (
    <div
      className={embedded ? "" : "p-10 max-w-7xl"}
